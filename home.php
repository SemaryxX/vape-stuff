            ...
            <div class="top-content">
                <div class="form-group">
                    <form action="" method="post">
                        <input type="text" placeholder="Search for liquids, coils and hardware..." class="form-control"><i class="fas fa-search"></i>
                        <div class="nicotine">
                            <input type="checkbox" name="" id="">Any
                            ...
                            <input type="checkbox" name="" id="">> More than
                        </div>
                    </form>
                </div>
				<div>HELLO New 2</div>
                <div class="result-content">
                    <div class="results">
                        ...
                        <h6>Store Phone : Nozaha Somking Shop</h6>
                        <h6>Store Address : Nozaha Somking Shop</h6>
                        <h6>Product : 007 Dr.no</h6>
                    </div>
                    <div class="results">
                        <h5>Store Name : Nozaha Somking Shop</h5>
                        <h6>Store Phone : Nozaha Somking Shop</h6>
